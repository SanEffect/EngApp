...
class LabelsDataSource(db: Database) : ILabelsDataSource {
    ...
    override fun getAllLabelsFlow(): Flow<List<Label>> = queries.selectAllLabels()
        .asFlow()
        .mapToList()
        .flowOn(ioDispatcher)
    ...
    override suspend fun upsertLabel(label: Label): Result<Unit> = doQuery {
    ...
    override suspend fun deleteLabel(labelId: String): Result<Unit> = doQuery {
